<form method="post">
	...
	<div class="col-md-4">
		<div class="form-group">
			<label for="" class="control-label">Limit respondents</label>
			<input type="text" name="limit_respondents" class="form-control">
		</div>
	</div>
	<hr>
...
if (isset($_POST['save'])) {
	...
	(title, description, start_date, end_date, date_created, poin, undian, limit_respondents)
	VALUES ('$title', '$description', '$start_date', '$end_date', '$bikin', '$poin', '$undian', '$limit_respondents')
		");
