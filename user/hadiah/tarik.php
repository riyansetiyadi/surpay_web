 <?php
  ...
  $ambil = $koneksi->query("SELECT nama, sum(poin) as total, hadiah.iduser, user.nama_lengkap from hadiah join user on hadiah.iduser=user.iduser where nama='$nama' group by nama ");
