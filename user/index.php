...
$pecahh=$ambilh->fetch_assoc()
 ...
 ?>
    <div style="background-color: white; height: 90px; width: 96%; margin-top: 6%; margin-left: 2%; border-radius: 25px"> <br>
        <span style="margin-left: 5%; margin-top: 70% ">Saldo Anda: <span style="font-size: 18px; font-weight: bold; color: red">Rp. <?php echo $pecahh['uang'] ?></span></span>
    </div>
