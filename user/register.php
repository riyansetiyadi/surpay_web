...
<head>
  ...
  <!-- Favicons -->
  <link href="../admin/dist/assets/img/khm.png" rel="icon">
      ...
      <center>
                  ...
                  <?php
                    if(isset($_POST['login'])){
                     ...
                     if ($row<=0) {
                         $koneksi->query("INSERT INTO `user`(`nohp`, `nama`, `password`, `provinsi`, `kota`, `kecamatan`, `kelurahan`, `kodepos`, `alamat`, `kelamin`, lahir) VALUES ('$nohp','$nama_lengkap','$password','$provinsi','$kota','$kecamatan','$kelurahan','$kode_pos','$alamat', '$jenis_kelamin', '$lahir')");
